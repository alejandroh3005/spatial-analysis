Dataset: AMGE71FL
Displacement Restriction: Province (admin1)
...
the Province. Therefore, the displaced cluster's coordinates are located within the same Country, Region,
and Province areas as the undisplaced cluster.
